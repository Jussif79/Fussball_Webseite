...
const articles = [
    {
        id: 1,
        title: 'UEFA Champions League: Key stats from Matchday 8',
        preview: 'Latest updates from the Champions League matches...',
    ...
    {
        id: 2,
        title: 'Player of the Month: Rising Star Performance',
    ...
    },
    {
        ...
        preview: 'Breaking transfer news from the top leagues...',
        timestamp: '15 h ago',
        image: 'https://via.placeholder.com/300x200',
