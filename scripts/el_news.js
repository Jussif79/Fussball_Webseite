...
const articles = [
    {
        id: 1,
        title: 'UEFA Europa League: Key stats from Matchday 6',
        preview: 'Latest updates from the Europa League matches...',
    ...
    {
        id: 2,
        title: 'Player of the Month: Rising Star Shines in Europa League',
    ...
    {
        id: 3,
        title: 'Transfer News: Europa League Star Attracts Major Interest',
        preview: 'Breaking transfer news involving Europa League talents...',
        timestamp: '15 h ago',
        image: 'https://via.placeholder.com/300x200',
